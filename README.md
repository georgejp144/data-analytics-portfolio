...
| [Realised Volatility Forecast - XGBoost](./realised-volatility-forecast-XGBoost/README.md) | Forecasting realised volatility using using Alpaca market data and an XGBoost model with HAR-style memory features and technical indicators. | Python, Alpaca API, statsmodels, xgboost |
| [Realised Volatility Forecast - LSTM](./realised-volatility-forecast-LSTM/README.md) | Forecasting realised volatility using using Alpaca market data and an LSTM model with HAR-style memory features and technical indicators. | Python, Alpaca API, statsmodels, LSTM |
