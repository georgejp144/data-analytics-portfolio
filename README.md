...
| [Realised Volatility Forecast](./realised-volatility-forecast/README.md) | Forecasting realised volatility using using Alpaca market data and an XGBoost model with HAR-style memory features and technical indicators. | Python, Alpaca API, statsmodels, xgboost |
